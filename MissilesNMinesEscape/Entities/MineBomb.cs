...
{
    /// <summary>
    /// MineBomb Class that allows the creation of minebombs
    /// </summary>
    public class MineBomb : DrawableGameComponent
    {
        ...
        /// <param name="sb">spritebatch for mines object</param>
        /// <param name="tex">texture2D for mines object</param>
        /// <param name="position">mines position</param>
        /// <param name="delay">kabminesom delay for animation<param>
